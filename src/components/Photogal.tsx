...
const Photogal: React.FC = () => {
  ...
  return (
    <section id="Photogal">
      <div className="flex w-full flex-col md:flex-row  mb-20 lg:mt-[5%] justify-center gap-4 items-center lg:items-stretch h-[100%]">
        {/* Text Container */}
        <div className="container lg:w-[40%] h-full flex justify-center items-center  flex-col p-8">
          <h1 className="text-4xl  uppercase text-center justify-center lg:text-left">
          ...
          <h2 className="text-6xl mt-4 font-Great lg:text-left">
            Discover. Immerse. Thrive.
          </h2>
          <Button onClick={handleClick} url="/Home" label="Learn More" />
        </div>

        {/* Image Container */}
        <div className=" hidden lg:block w-[353.38px]  h-[345.47px] lg:right-[1%]  relative">
          {/* Image 1 */}
          <Image
            className=" w-[200.90px] h-[240.19px] left-[210.47px] top-[131.28px] absolute"
            src="/one.jpg"
            alt="Image 1"
            width={500}
            height={500}
          ...
          {/* Image 2 */}
          <Image
            className=" w-[200.90px] h-[250.19px] left-[100.58px] top-[59.59px] absolute"
            src="/two.jpg"
            alt="Image 2"
            width={500}
            height={500}
